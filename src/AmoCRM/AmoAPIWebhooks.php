...
trait AmoAPIWebhooks
{
     ...
     */
    public static function addWebhooks(array $params, bool $returnResponse = false,?string $subdomain = null)
    {
    ...
    protected static function isNumericArray($variable) :bool
    {
        ...
        return array_all(array_keys($variable), fn($key): bool => $key === (int) $key);
    }
}
